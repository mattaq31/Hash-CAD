...
if __name__ == '__main__':
    ...
    #         color='black', fontsize=18, verticalalignment='center', horizonMINtalalignment='center',
    #         bbox=dict(facecolor='white', alpha=0.8, edgecolor='none'))

    # Labeling with larger font sizes
    plt.xlabel('Binding Energy (kcal/mol)', fontsize=22)
    plt.ylabel('Probability', fontsize=22)
    plt.title('On Target vs Off Target Binding Energies', fontsize=28)
    ...
    plt.savefig(name + "newsetnoline.pdf", format="pdf", dpi=600)
    plt.show()
