...
echo_folder = os.path.join(experiment_folder, 'echo_session_2')
lab_helper_folder = os.path.join(experiment_folder, 'lab_helpers_session_2')
...
for m, design_name in zip([mega_unseeded], ['unseeded_ribbon']):
    ...
    if generate_echo:
        commands_barrels = convert_slats_into_echo_commands(slat_dict=slats_with_dups,
                                                                  ...
                                                                  reference_transfer_volume_nl=112.5,
        ...
        prepare_all_standard_sheets(slats_with_dups, os.path.join(lab_helper_folder, f'zigzag_{design_name}_helpers.xlsx'),
                                    reference_single_handle_volume=112.5,
