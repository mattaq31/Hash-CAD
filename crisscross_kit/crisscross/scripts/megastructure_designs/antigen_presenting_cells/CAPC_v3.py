...
########## CONFIG
experiment_folder = '/Users/matt/Partners HealthCare Dropbox/Matthew Aquilina/Origami Crisscross Team Docs/Crisscross Designs/CAPCs/v3_rigid_cross'
...
design_file = os.path.join(experiment_folder, 'rigid_cross_design.xlsx')
...
mega.patch_placeholder_handles(main_plates + (src_004, src_010))
...
if generate_echo:
    ...
    commands_barrels = convert_slats_into_echo_commands(slat_dict=mega.slats,
                                                        destination_plate_name=f'capc_v3',
                                                        reference_transfer_volume_nl=ref_vol,
                                                        output_folder=echo_folder,
                                                        center_only_well_pattern=False,
                                                        plate_viz_type='barcode',
                                                        normalize_volumes=True,
                                                        output_filename=f'capc_v3_echo.csv')

    prepare_all_standard_sheets(mega.slats, os.path.join(lab_helper_folder, f'capc_v3.xlsx'),
