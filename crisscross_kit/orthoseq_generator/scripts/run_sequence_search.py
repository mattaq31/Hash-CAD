...
Main Steps:
    ...
    5. Run the hybrid search algorithm to find a set of sequences with minimal cross-interaction.
...
if __name__ == "__main__":
    ...
    # 5) Run the hybrid search algorithm to find an orthogonal set of sequences
