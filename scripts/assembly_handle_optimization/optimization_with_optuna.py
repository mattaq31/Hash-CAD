...
def optuna_optim(trial):
    ...
    ergebüsse = evolve_handles_from_slat_array(slat_array,
                                               ...
                                               log_tracking_directory=trial_folder,
                                               optuna_optimization_trial=trial)

    final_physics_score = multirule_oneshot_hamming(slat_array,
                                                    ergebüsse,
                                                    per_layer_check=False,
                                                    report_worst_slat_combinations=False,
                                                    request_substitute_risk_score=False)['Physics-Informed Partition Score']
