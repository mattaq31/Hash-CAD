...
import sequence_generator.vertex_cover_algorithms as vca
import pickle
...
if __name__ == "__main__":
    ...
    vertex_cover = vca.iterative_vertex_cover_multi(vertices, edges, preserve_V=None, num_vertices_to_remove=200, max_iterations=500, limit=70,
